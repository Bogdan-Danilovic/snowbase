...
/**
 * partials/head.php
 * Zajednicki <head> blok za sve Snowbase stranice.
 *
 * Stranica pre `include` postavlja:
 *   $page_title       — naslov stranice (obavezno)
 *   $page_extra_head  — opciono, dodatni <style>/<meta>/<link>
 */
?>
<!DOCTYPE html>
<html lang="sr">
<head>
    ...
    <title><?php echo htmlspecialchars($page_title ?? 'Snowbase — Premium Alpine Travel'); ?></title>
